...
public class us extends RocksObject {
  ...
  public ValueType getValueType() {
    ...
    return ValueType.getValueType(getValueTypeJni(nativeHandle_));
  }
  ...
  private static native byte getValueTypeJni(final long handle);
